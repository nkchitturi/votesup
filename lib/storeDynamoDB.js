...
function Constructor() {
    ...
    this.init = function(cb) {
        ...
        if (process.env.hasOwnProperty('VOTESUP_DDB_TABLE_NAME')) {
            ...
            // if VOTESUP_DDB_TABLE_NAME is not set, assume we're running in dev
            ddbTableName = 'votesup_dev';
            ddb = new AWS.DynamoDB({
    ...
    this.getSiteCounts = function(siteName, colorCounts, cb) {
        ...
        console.log('Get StandUp Time vote counts for ' + siteName);
    ...
    this.addVote = function(siteName, colorName, cb) {
        /*jshint -W106 */
        var updateParams = {
